                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            <form role="form" action="{{URL::to('/admin/create-course')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="exampleInputImageCourse">Image Course</label>
                                <input type="file" name="course_image" class="form-control" id="exampleInputImageCourse">
                            </div>
